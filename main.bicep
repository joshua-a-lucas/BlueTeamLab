...
resource domainControllerConfiguration 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    settings: {
      ModulesUrl: 'https://github.com/joshua-a-lucas/BlueTeamLab/main/modules/Deploy-DomainServices.zip'
...
resource workstationConfiguration 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    autoUpgradeMinorVersion: true
    settings: {
      ModulesUrl: 'https://github.com/joshua-a-lucas/BlueTeamLab/main/modules/Join-Domain.zip'
